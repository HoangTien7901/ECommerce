...
public class HomeRestController {
	...
	@RequestMapping(value = "search/{id}", method = RequestMethod.GET, produces = MimeTypeUtils.APPLICATION_JSON_VALUE)
	public ResponseEntity<Products> findById(@PathVariable int id){
		try {
			return new ResponseEntity<Products>(productService.findById(id), HttpStatus.OK);
		}catch(Exception e) {
