...
<link rel="stylesheet"
	href="${pageContext.request.contextPath }/resources/user/css/easyzoom.css">
<link rel="stylesheet"
			...
			<div class="container-fluid">
				<div class="header-bottom-wrapper">
					...
					<div class="header-cart">
						<a class="icon-cart-furniture" href="#"> <i
						...
						<ul class="cart-dropdown">
							<li class="single-product-cart">
								<div class="cart-img">
									<a href="#"><img
										src="${pageContext.request.contextPath }/resources/user/img/cart/1.jpg"
										alt=""></a>
								</div>
							...
							<li class="single-product-cart">
								<div class="cart-img">
									<a href="#"><img
										src="${pageContext.request.contextPath }/resources/user/img/cart/2.jpg"
										alt=""></a>
								</div>
								<div class="cart-title">
									<h5>
							...
							<li class="single-product-cart">
								<div class="cart-img">
									<a href="#"><img
										src="${pageContext.request.contextPath }/resources/user/img/cart/3.jpg"
										alt=""></a>
								</div>
								<div class="cart-title">
									<h5>
							...
							<li class="cart-btn-wrapper"><a class="cart-btn btn-hover"
								href="#">view cart</a> <a class="cart-btn btn-hover" href="#">checkout</a>
							</li>
						</ul>
					</div>
				</div>
				...
				<div class="col-md-12 col-lg-7 col-12">
					<div class="product-details-img-content">
						<div class="product-details-tab mr-70">
							<div class="product-details-large tab-content"></div>
							<div class="product-details-small nav mt-12" role=tablist>
								<c:forEach var="imageName" items="${imageProduct }">
									<a class="mr-12" href="#pro-details2" data-toggle="tab"
										role="tab" aria-selected="true"> <img
										src="${pageContext.request.contextPath }/resources/user/img/product-details/${imageName.name}"
										alt="">
									</a>
								</c:forEach>
							</div>
					...
					<div class="product-details-content">
						...
						<div class="rating-number">
							...
							<div class="quick-view-number">
								<span>
									<h6>
										${product.ratingCount } <i class="pe-7s-star"></i>
									</h6>
								</span>
							</div>
						</div>
			...
			<div class="product-description-review text-center">
				<div class="description-review-title nav" role=tablist>
					<a class="active" href="#pro-dec" data-toggle="tab" role="tab"
						aria-selected="true"> Description </a> <a href="#pro-review"
						data-toggle="tab" role="tab" aria-selected="false"> Reviews
						(0) </a>
				</div>
				...
				<div class="related-product-active owl-carousel">
					<div class="product-wrapper">
						<div class="product-img">
							<a href="#"> <img
								src="${pageContext.request.contextPath }/resources/user/img/product/fashion-colorful/1.jpg"
								alt="">
							</a> <span>hot</span>
					...
					<div class="product-wrapper">
						<div class="product-img">
							<a href="#"> <img
								src="${pageContext.request.contextPath }/resources/user/img/product/fashion-colorful/2.jpg"
								alt="">
							</a>
							<div class="product-action">
								<a class="animate-left" title="Wishlist" href="#"> <i
					...
					<div class="product-wrapper">
						<div class="product-img">
							<a href="#"> <img
								src="${pageContext.request.contextPath }/resources/user/img/product/fashion-colorful/3.jpg"
								alt="">
							</a> <span>hot</span>
							<div class="product-action">
								<a class="animate-left" title="Wishlist" href="#"> <i
					...
					<div class="product-wrapper">
						<div class="product-img">
							<a href="#"> <img
								src="${pageContext.request.contextPath }/resources/user/img/product/fashion-colorful/4.jpg"
								alt="">
							</a>
							<div class="product-action">
								<a class="animate-left" title="Wishlist" href="#"> <i
					...
					<div class="product-wrapper">
						<div class="product-img">
							<a href="#"> <img
								src="${pageContext.request.contextPath }/resources/user/img/product/fashion-colorful/5.jpg"
								alt="">
							</a> <span>hot</span>
							<div class="product-action">
								<a class="animate-left" title="Wishlist" href="#"> <i
