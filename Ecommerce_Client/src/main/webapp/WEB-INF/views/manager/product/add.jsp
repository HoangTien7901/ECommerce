					...
					<div class="row">
						<div class="col-md-12">
							...
							<div class="card card-primary">
								...
								<!-- form start -->
								<s:form method="POST"
								action="${pageContext.request.contextPath }/manager/product/create"
								modelAttribute="item" enctype="multipart/form-data">
									<div class="card-body">
										...
										<div class="form-group">
											<a id="linkPreview" data-toggle="lightbox" data-title="Product's new avatar"
												href="${pageContext.request.contextPath }/uploads/images/defaultPreviewImg.png">
