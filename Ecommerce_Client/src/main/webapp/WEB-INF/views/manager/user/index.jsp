										...
										<tbody>
											<c:forEach var="item" items="${items }" varStatus="varStatus">
												<tr>
													...
													<td>
													<a
													href="${pageContext.request.contextPath }/manager/user/edit/${item.id }">
													...
													<a
													href="${pageContext.request.contextPath }/manager/user/${item.status ? 'ban' : 'toggleStatus' }/${item.id }">
															<button type="button"
