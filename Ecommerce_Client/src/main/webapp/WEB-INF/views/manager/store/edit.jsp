					...
					<div class="row mb-2">
						...
						<div class="col-sm-6">
							<ol class="breadcrumb float-sm-right">
								...
								<li class="breadcrumb-item"><a href="${pageContext.request.contextPath }/manager/store/index">${parentPageTitle }</a></li>
							...
							<div class="card card-primary">
								...
								modelAttribute="item" enctype="multipart/form-data">
									<div class="card-body">
										...
										<div class="form-group">
											<s:label path="userId">Store's owner</s:label>
											<s:select path="userId" cssClass="form-control">
												<s:options items="${users}" itemLabel="username" itemValue="id"></s:options>
											</s:select>
										</div>
