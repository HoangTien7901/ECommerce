		...
		<aside class="main-sidebar sidebar-dark-primary elevation-4">
			...
			<div class="sidebar">
               ...
               with font-awesome or any other icon font library -->
						<li class="nav-item menu-open"><a href="${pageContext.request.contextPath }/manager/banner/index"
										...
										<tbody>
											<c:forEach var="banner" items="${banners }">
												<tr>
													...
													<td>${banner.updated }</td>
													<td>${banner.status }</td>
													<td><a
														href="${pageContext.request.contextPath }/manager/banner/edit/${banner.id }"><i
															class="far fa-edit"></i></a> | <a
														href="${pageContext.request.contextPath }/manager/banner/delete/${banner.id }"><i
