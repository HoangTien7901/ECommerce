				...
				<div class="container-fluid">
					<div class="row">
						<div class="col-12">
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<!-- This will cause the card to collapse when clicked -->
										<a
										href="${pageContext.request.contextPath }/manager/notification/addUser">
								...
								<div class="card-body">
									<table id="dataTable1" class="table table-bordered table-hover">
										...
										<tbody>
											<c:forEach var="item" items="${users }" varStatus="varStatus">
												<tr>
													...
													<td><a
													href="${pageContext.request.contextPath }/manager/notification/editUser/${item.id }">
							...
							<div class="card">
								<div class="card-header">
									...
									<div class="card-tools">
										...
										<!-- This will cause the card to collapse when clicked -->
										<a
										href="${pageContext.request.contextPath }/manager/notification/addStore">
											<button type="button" class="btn btn-primary">Add</button>
										</a>
									</div>
								</div>
								...
								<div class="card-body">
									<table id="dataTable2" class="table table-bordered table-hover">
										...
										<tbody>
											<c:forEach var="item" items="${stores }" varStatus="varStatus">
												<tr>
													<td>${varStatus.getCount() }</td>
													...
													<td><a
													href="${pageContext.request.contextPath }/manager/notification/editStore/${item.id }">
															<button type="button" class="btn btn-primary">
																<i class="far fa-edit"></i>
															</button>
													</a> |
							...
							<div class="card">
								<div class="card-header">
									<h3 class="card-title">${pageTitle3 }</h3>
									<div class="card-tools">
										<!-- This will cause the card to collapse when clicked -->
      									<button type="button" class="btn btn-tool"
										data-card-widget="collapse">
										...
										<!-- This will cause the card to collapse when clicked -->
										<a
										href="${pageContext.request.contextPath }/manager/notification/addAll">
											<button type="button" class="btn btn-primary">Add</button>
										</a>
									</div>
								</div>
								...
								<div class="card-body">
									<table id="dataTable3" class="table table-bordered table-hover">
										...
										<tbody>
											<c:forEach var="item" items="${all }" varStatus="varStatus">
												<tr>
													<td>${varStatus.getCount() }</td>
													<td>${item.isAllUser() ? "User" : "Store" }</td>
													<td>${item.content }</td>
													<td>
													<fmt:formatDate var="created"
														value="${item.created }" pattern="dd/MM/yyyy" />
													...
													<td><a
													href="${pageContext.request.contextPath }/manager/notification/editAll/${item.id }">
															<button type="button" class="btn btn-primary">
																<i class="far fa-edit"></i>
															</button>
													</a> |
		...
		<div class="modal-dialog">
			<div class="modal-content bg-danger">
				...
				<div class="modal-footer justify-content-between">
					...
					<a id="deleteLink"
							data-link="${pageContext.request.contextPath }/manager/notification/delete/"
							href="#">
