...
<meta name="viewport" content="width=device-width, initial-scale=1">
  <title>Modern Multi Image Uploader Example</title>
  ...
  <link rel="stylesheet" href="/resources/stores/assets/plugin/upload-images/jquery.imagesloader.css">
  ...
  <!-- Images loader -->
  <script src="/resources/stores/assets/plugin/upload-images/jquery.imagesloader-1.0.1.js"></script>
<style>
  ...
  <form id="frm" enctype="multipart/form-data"  method="post"
      ...
      <div class="form-group row">
        <div class="input-group">
          ...
          <input id="files"  type="file" name="photos" onchange="previewFile(this);" data-button="" multiple="multiple" accept="image/jpeg, image/png, image/gif," style="display: none" >
        </div>
      </div>
