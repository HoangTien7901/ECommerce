...
public class TagController {
	...
	public String save(@ModelAttribute("item") TagInfo item) {
		ResponseEntity<Void> responseEntity = tagService.update(item);
		if (responseEntity != null && responseEntity.getStatusCode() == HttpStatus.OK) {
//			TagInfo result = responseEntity.getBody();
		} else {
			System.out.println("Client - Update tag result" + responseEntity == null ? "null" : responseEntity.getStatusCode());
		}
	...
	public String create(@ModelAttribute("item") TagInfo item) {
...
//			TagInfo result = responseEntity.getBody();
			...
			System.out.println("Client - Add tag result" + responseEntity == null ? "null" : responseEntity.getStatusCode());
		}
