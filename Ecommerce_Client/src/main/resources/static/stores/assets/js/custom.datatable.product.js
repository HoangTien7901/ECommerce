...
$(document).ready(function() {		
	$('#example1').DataTable({
		...
		pageLength : 5,
		ajax : {
			url : path + '/product/findByStore/1',
			dataSrc : ''
		},
		columns : [ 
			{
			...
			{title : 'Original price', data : 'originalPrice'},
			{title : 'Price', data : 'price'},
			{title : 'Quantity', data : 'quantity'},
			{title : 'Inventory', data : 'inventory'}, 
			{title : 'Quantity', data : 'quantity'},
			{title : 'Discount %', data : 'discountPercent'},
			{title : 'Discount amount', data : 'discountAmount'},
			{title : 'Rating count', data : 'ratingCount'},
			{title : 'Rating average', data : 'ratingAverage'},
